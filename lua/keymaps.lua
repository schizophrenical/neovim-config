...
whichkey.register({
  ['<leader>'] = {
    ...
    f = {
      name = 'Find Files ...',
      f = {
        "<CMD>silent lua require('telescope.builtin').find_files()<CR>",
        'Find File(s)',
      },
      s = {
        "<CMD>silent lua require('telescope.builtin').current_buffer_fuzzy_find()<CR>",
        'Search in File',
      },
      r = {
        "<CMD>silent lua require('telescope').extensions.recent_files.pick()<CR>",
        'Find File(s)',
      },
      b = {
        "<CMD>silent lua require('telescope.builtin').buffers()<CR>",
        'List Active Buffers',
      },
      h = {
        "<CMD>silent lua require('telescope.builtin').help_tags()<CR>",
        'Find Help Tags',
      },
      g = {
        "<CMD>silent lua require('telescope.builtin').live_grep()<CR>",
        'Live Grep',
      },
      t = { "<CMD>silent lua require('nvim-tree').toggle()<CR>", 'File Tree' },
      i = {
        "<CMD>silent lua require('nvim-tree/api').tree.focus()<CR>",
        'Focus File Tree',
      },
    },
    -- Terminal
    t = {
      name = 'Terminal ...',
      d = {
        "<CMD>silent lua require('terminal').new()<CR>",
    ...
    g = {
      ...
      i = {
        '<CMD>silent DiffviewOpen -- %<CR>',
        'Diff to Index (Current File)',
      },
      h = { '<CMD>silent DiffviewFileHistory %<CR>', 'History (Current File)' },
      b = { '<CMD>silent DiffviewFileHistory<CR>', 'History (Branch)' },
      B = {
        '<CMD>silent DiffviewFileHistory --no-merges<CR>',
        'History (Branch - No merges)',
      },
      x = { '<CMD>silent DiffviewClose<CR>', 'Close Diff View' },
      t = {
        "<CMD>silent lua require('gitsigns').toggle_current_line_blame()<CR>",
        'Toggle Line Blame',
      },
      p = {
        "<CMD>silent lua require('gitsigns').preview_hunk_inline()<CR>",
        'Preview Hunk Inline',
      },
      r = {
        "<CMD>silent lua require('gitsigns').reset_hunk()<CR>",
        'Reset Change',
      },
      s = {
        "<CMD>silent lua require('gitsigns').stage_hunk()<CR>",
        'Stage Change',
      },
      S = {
        "<CMD>silent lua require('gitsigns').stage_buffer()<CR>",
        'Stage File',
      },
      n = {
        "<CMD>silent lua require('gitsigns').next_hunk()<CR>",
        'Next Change',
      },
      N = {
        "<CMD>silent lua require('gitsigns').prev_hunk()<CR>",
        'Previous Change',
      },
      u = {
        "<CMD>silent lua require('gitsigns').undo_stage_hunk()<CR>",
        'Unstage Change',
      },
    },
    -- Generate Code Docs
    a = {
      ...
      c = {
        "<CMD>silent lua require('neogen').generate({type = 'class'})<CR>",
        'Classes Annotations',
      },
      m = {
        "<CMD>silent lua require('neogen').generate({type = 'func'})<CR>",
        'Method/Func Annotations',
      },
    },
    -- Colorizer
    c = {
      ...
      name = 'Colorizer',
      l = {
        "<CMD>silent lua require('colorizer')<CR>",
        'Load colorizer plugin',
      },
